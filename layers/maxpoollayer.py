...
class MaxPoolLayer(BaseLayer):
    ...
    def reshape(self):
        # fetch parameters
        self.name = self.args.get('name', 'max_pool')
    ...
    def forward(self, bottom):
        ...
        self.top = op_conv2d_separate(self.bottom, self.kernel, self.strides, 'maxpool')
        return self.top
    ...
    def backward(self, grad_top):
        ...
        self.grad_bottom = op_conv2d_separate_backprop(grad_top, self.bottom, self.kernel,self.strides,'maxpool')
